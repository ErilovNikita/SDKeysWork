...
<template>
    <div class="container">
        <p class="mb-0 fw-bolder">Список найденных ключей</p>
        <!-- <p class="mb-3 text-muted">Найдено {{baseStore.data.data.length}} шт.</p> -->
        <table class="table mt-4 w-100">
            <thead>
                <tr>
                    <th class="fw-normal" scope="col" style="width: 40%;">Ключ</th>
                    <th class="fw-normal" scope="col" style="width: 15%;">Дата создания</th>
                    <th class="fw-normal" scope="col" style="width: 15%;">Конец жизни</th>
                    <th class="fw-normal" scope="col" style="width: 7%;">Тип</th>
                    <th class="fw-normal" scope="col" style="width: 3%;">Активный</th>
                    <th class="fw-normal" scope="col" style="width: 20%;">Сотрудник</th>
                </tr>
            </thead>
            <tbody class="tableBody">
                <tr v-for="accessKey in baseStore.data.data">
                    <td @click='copy(accessKey["uuid"])' class="copyData">
                        {{accessKey["uuid"]}} 
                    ...
                    <td>{{parseDate(accessKey["creationDate"])}}</td>
                    <td>{{parseDate(accessKey["deadline"])}}</td>
                    <td>{{parseType(accessKey["type"])}}</td>
